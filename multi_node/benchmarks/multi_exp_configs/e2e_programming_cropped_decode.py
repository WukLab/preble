...
configuration_to_test = [
    ...
    # scale_to_gpu([100, 2000, 5], len(ours_gpu_configs) // 2),
...
loogle_experiment = ConfigurableMajorExperimentArgs(
    log_file_path="programming_logs/programming_9.log",
    csv_log_path="programming_logs/programming_9.csv",
