...
policies_to_test = [
    ...
    (DataParallelRuntimeSelectionPolicy.CUSTOM, CustomPolicyType.TraceOracle, baseline_gpu_configs, ''),
]
...
toolbench_experiment = ConfigurableMajorExperimentArgs(
    log_file_path="e2e_version2/mixed_azure_trace_final_random/4_gpu_random.log",
    csv_log_path="e2e_version2/mixed_azure_trace_final_random/4_gpu_random.csv",
