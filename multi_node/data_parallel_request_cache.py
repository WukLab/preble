...
class DataParallelRequestRouter:
    ...
    def select_runtime(self, text, experiment_id, request_id, input_ids=None, sampling_params=None, current_time_stamp=None, runtime_id_with_highest_hit_rate=None, **kwargs) -> int:
        if self.runtime_selection_policy == DataParallelRuntimeSelectionPolicy.RANDOM:
            ...
            selected_runtime = self.custom_selector.runtime_selector(text, request_id, input_ids, sampling_params, current_time_stamp=current_time_stamp, runtime_id_with_highest_hit_rate=runtime_id_with_highest_hit_rate)
        else:
